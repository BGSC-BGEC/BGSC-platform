...
export class RegisterDto {
  @ApiProperty({ description: 'Unique username', example: 'john_doe', minLength: 3, maxLength: 50 })
  @IsString()
  @MinLength(3)
  @MaxLength(50)
  ...
  @ApiProperty({ description: 'Password (min 8 chars, 1 uppercase, 1 number, 1 special)', example: 'P@ssw0rd!' })
  @IsString()
  @MinLength(8)
